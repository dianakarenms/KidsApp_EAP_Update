...
public class Demo_GoNoGo extends AppCompatActivity {
    int curTime = 2000;
    ...
    boolean firstFlag = true;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_comenzarjuego);
            context = this;
        ...
        public void onBackPressed() {
            super.onBackPressed();
            Intent i = new Intent(Demo_GoNoGo.this, ElegirEjercicioActivity.class);
