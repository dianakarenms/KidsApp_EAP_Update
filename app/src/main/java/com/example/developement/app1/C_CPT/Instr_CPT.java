package com.example.developement.app1.C_CPT;
...
public class Instr_CPT extends AppCompatActivity implements View.OnClickListener
{
    TextToSpeech t1;
    ImageButton boton;
    TextView txt;
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.btnDemo:
                Intent intent= new Intent(this,Demo_CPT.class);
                intent.putExtra("exerciseId", exerciseId);
                        startActivity(intent);
                break;
            case R.id.BTNjugar:
                Intent btnnueve= new Intent(this, Juego_CPT.class);
