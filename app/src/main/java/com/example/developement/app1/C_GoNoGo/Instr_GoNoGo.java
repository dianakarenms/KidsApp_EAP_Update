package com.example.developement.app1.C_GoNoGo;
...
public class Instr_GoNoGo extends AppCompatActivity implements View.OnClickListener
{
    TextToSpeech t1;
    ImageButton boton;
    TextView txt;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.gonogo_instr);
    ...
    public void onClick(View v)
    {
        ...
        {
            case R.id.btnDemo:
                Intent intent= new Intent(this,Demo_GoNoGo.class);
                intent.putExtra("exerciseId", exerciseId);
                        startActivity(intent);
                break;
            case R.id.BTNjugar:
                Intent btnnueve= new Intent(this, Juego_GoNoGo.class);
