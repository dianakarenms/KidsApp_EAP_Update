...
public class DemoRedesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSwitcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ImageView imageView = new ImageView(DemoRedesActivity.this);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.continuarBtn:
                    finish();
                    Intent intentE = new Intent(DemoRedesActivity.this, ElegirEjercicioActivity.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        /*Intent i = new Intent(DemoRedesActivity.this, ElegirEjercicioActivity.class);
